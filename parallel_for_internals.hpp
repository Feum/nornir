...
#ifndef ADAPTIVE_FASTFLOW_PARFOR_INTERNALS_HPP_
#define ADAPTIVE_FASTFLOW_PARFOR_INTERNALS_HPP_
...
class ff_forall_farm: public adp_ff_farm<foralllb_t> {
public:
...
public:
    ...
    ff_forall_farm(ssize_t maxnw, const bool spinwait=false, const bool skipwarmup=false, const bool spinbarrier=false):
        adp_ff_farm<foralllb_t>(false,8*ff_farm<>::DEF_MAX_NUM_WORKERS,8*ff_farm<>::DEF_MAX_NUM_WORKERS,
...
#endif /* ADAPTIVE_FASTFLOW_PARFOR_INTERNALS_HPP_ */
