...
def run(contractType, fieldName, fieldValue, percentile, itnum):
    ...
    if contractType == "PERF_COMPLETION_TIME":
        parametersFile.write("<maxPrimaryPredictionError>20.0</maxPrimaryPredictionError>\n")
    else:
        parametersFile.write("<maxSecondaryPredictionError>20.0</maxSecondaryPredictionError>\n")
